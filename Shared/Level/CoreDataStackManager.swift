...
//  ColorWars
//
//  Created by Kirill Botalov on 03.08.16.
...
class CoreDataStackManager {
    ...
    static let defaultStack = CoreDataStackManager()
    ...
    lazy var applicationDocumentsDirectory: URL = {
        ...
        var applicationDocumentsDirectoryName = "ColorWars"
        /*
        if Bundle.main.bundleIdentifier != nil {
            applicationDocumentsDirectoryName = Bundle.main.bundleIdentifier!
        }
        */
        ...
        let applicationSupportDirectory = applicationSupportDirectoryURL.appendingPathComponent(applicationDocumentsDirectoryName)
    ...
    // The directory the application uses to store the Core Data store file. This code uses a directory named "KVB.Core_Data" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "ColorWars", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("ColorWars.sqlite")
